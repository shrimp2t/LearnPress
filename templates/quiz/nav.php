...
<div class="quiz-question-nav-buttons">
    ...
    <button type="button" data-nav="prev"  class="prev-question btn" data-url="<?php echo $prev;?>"><?php echo apply_filters( 'learn_press_quiz_question_nav_button_back_title', __( 'Back', 'learn_press' ) );?></button>
    <?php //}?>
    <?php //if( $next = learn_press_get_user_next_question_url( get_the_ID(), $question_id ) ){?>
    <button type="button" data-nav="next" class="next-question btn" data-url="<?php echo $next;?>"><?php echo apply_filters( 'learn_press_quiz_question_nav_button_next_title', __( 'Next', 'learn_press' ) );?></button>
    <?php //}?>
